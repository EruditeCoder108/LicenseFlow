...
for (const asset of ['face_landmarker.task', 'efficientdet_lite0_uint8.tflite', 'vision-wasm/vision_wasm_internal.wasm', 'vision-wasm/vision_wasm_nosimd_internal.wasm']) {
