...
6. Payment: the fee and consent are shown before a clearly labelled simulated gateway. Its sandbox service creates one server-saved attempt and reference per idempotency key. Payment can be not started, processing, successful, failed or uncertain; an uncertain return must be checked before retry. No bank details are accepted and no real money moves.
