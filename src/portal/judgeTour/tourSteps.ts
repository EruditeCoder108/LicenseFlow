...
const rawSteps: StepInput[] = [
  ...
  step('test-overview', 'learn-test', '[data-tour="test-question-overview"]', '/mp/application/:id/test', 'Test interface', 'The question, choices, timer, read-aloud button, progress map and camera status are visible together.', 'Show the judge result button', 'advance', 'top', 'working'),
